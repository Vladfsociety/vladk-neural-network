...
def run_iris_test(
    learning_rate=0.001, cce_threshold=0.1, acc_threshold=0.9, fit_time_threshold=4.0
):
...
def run_digits_test(
    learning_rate=0.001, cce_threshold=0.6, acc_threshold=0.90, fit_time_threshold=20.0
):
