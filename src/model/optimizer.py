...
class Adam:
    ...
    def update(self, layers, delta_w, delta_b, batch_size):
        ...
        while layer_index > 0:
            ...
            layers[layer_index]['w'] -= (
                    (self.__learning_rate * first_moment_w)
            ...
            layers[layer_index]['b'] -= (
                    (self.__learning_rate * first_moment_b)
    ...
    def __get_first_moment_w(self, layer_index, delta_w):
        ...
        first_moment_w = self.__beta_1 * first_moment_w + (1.0 - self.__beta_1) * delta_w[layer_index - 1]
    ...
    def __get_second_moment_w(self, layer_index, delta_w):
        ...
        second_moment_w = self.__beta_2 * second_moment_w + (1.0 - self.__beta_2) * (delta_w[layer_index - 1] ** 2)
    ...
    def __get_first_moment_b(self, layer_index, delta_b):
        ...
        first_moment_b = self.__beta_1 * first_moment_b + (1.0 - self.__beta_1) * delta_b[layer_index - 1]
    ...
    def __get_second_moment_b(self, layer_index, delta_b):
        ...
        second_moment_b = self.__beta_2 * second_moment_b + (1.0 - self.__beta_2) * (delta_b[layer_index - 1] ** 2)
