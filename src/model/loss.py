...
class BinaryCrossEntropy:
    ...
    def value(self, prediction, actual):
        ...
        prediction = torch.clamp(prediction, min=self.__epsilon, max=1.0 - self.__epsilon)
...
class CategoricalCrossEntropy:
    ...
    def value(self, prediction, actual):
        ...
        softmax_prediction = torch.clamp(softmax_prediction, min=self.__epsilon, max=1.0 - self.__epsilon)
